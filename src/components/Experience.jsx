    ...
    <div className="font-thin font-sans w-full text-center bg-gray-100 py-16">
      <div className="lg:mx-64 md:mx-24 sm:mx-8">
        ...
        <p className="tracking-wide leading-loose mb-6">
          ...
          building intuitive, responsive, and visually engaging user interfaces.
          My passion lies in crafting seamless digital experiences that not only
          meet business objectives but also delight users. Here are a few
